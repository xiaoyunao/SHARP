...
def main():
    ...
    ap.add_argument("--root", default="/processed1", help="input root, contains <night>/L2")
    ap.add_argument("--gaia-dir", default="/pipeline/ref/healpix", help="Gaia healpix directory")
    ap.add_argument("--out-root", default="/pipeline/xiaoyunao/data/heliolincrr", help="output root directory")
