...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--root-dir", default=str(project_root / "survey_local"))
    parser.add_argument("--workspace", default=str(project_root / "local_data" / "survey" / "runtime"))
    parser.add_argument("--footprints", default=str(project_root / "survey_local" / "footprints" / "equatorial_footprints.fits"))
    parser.add_argument("--processed-root", default=str(project_root / "local_data" / "processed1"))
