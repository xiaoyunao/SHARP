...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--root", default=str(Path(__file__).resolve().parent.parent / "local_data" / "processed1"), help="Root directory containing <NIGHT>/L2")
    p.add_argument("--outdir", default="./products", help="Output directory")
    p.add_argument("--astorb", default=str(Path(__file__).resolve().parent.parent / "resources" / "known_asteroid" / "astorb.dat"), help="Path to astorb.dat")
